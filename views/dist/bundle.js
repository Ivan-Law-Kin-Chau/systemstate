...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  var SSSender = class {
    ...
    push(functionName, functionParameters) {
      if (typeof functionName !== "string" || !(functionName.length > 0))
        throw "Function name error";
      if (typeof functionParameters !== "string" || !(functionParameters.length > 0))
        throw "Function parameters error";
  ...
  // src/classes/Items/All.js
  var All_exports = {};
  __export(All_exports, {
    SSGroup: () => SSGroup,
    SSLink: () => SSLink,
    SSObject: () => SSObject,
    SSProperty: () => SSProperty
  });
  ...
  function isValidKey(input) {
    ...
    if (input.length !== 8)
      return false;
    for (let i = 0; i < 8; i++) {
      if ("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789".indexOf(input.charAt(i)) === -1)
        return false;
    }
    return true;
  }
  ...
  function isValidSingleLineString(input) {
    if (typeof input !== "string")
      return false;
  ...
  function isValidMultiLineString(input) {
    if (typeof input !== "string")
      return false;
    return true;
  }

  // src/classes/Elements/All.js
  var All_exports2 = {};
  __export(All_exports2, {
    ...
    SSTextarea: () => SSTextarea,
    SSThis: () => SSThis
  });

  // src/scripts/convertor.js
  function convertHTMLToBoolean(input) {
    if (input == null) {
      return null;
    } else if (input == "1") {
      return true;
  ...
  function convertBooleanToDirection(input) {
    if (input === null) {
      return "<->";
    } else if (input === true) {
      return "->";
  ...
  function convertCamelCaseToSS(input) {
    if (typeof input === "string") {
  ...
  // src/classes/Elements/SSElement.jsx
  var React = __toESM(require_react());
  var SSElement = class extends React.Component {
    simulate(input) {
  ...
  // src/classes/Elements/SSThis.jsx
  var React3 = __toESM(require_react());

  // src/scripts/identifier.js
  function identityToString(type, identity) {
    if (type === "group") {
  ...
  function identityFromString(type, identityString) {
    if (type === "group") {
      var identity = {
  ...
  // src/classes/SSExpander.js
  var SSExpander = class {
    ...
    async expand(uuid) {
      ...
      const iterate = async function(uuid2, iterateFunction) {
        ...
        for (let searchArrayIndex = 0; searchArrayIndex < searchArrays.length; searchArrayIndex++) {
          ...
          if (assembly.clientOnlyMode === false) {
            searchResult = (await sender.send("search", `("${array.split("_")[1]}", "${uuid2}", "${array.split("_")[0]}")`))._output;
          } else {
            searchResult = [];
            ...
            for (const itemKey in searchArea) {
              ...
              if (array.split("_")[0] === "group") {
                if (item["_" + array.split("_")[1]] === uuid2)
                  searchResult.push({ _uuid: item._uuid, _parent: item._parent });
              } else {
                if (item["_" + array.split("_")[1]] === uuid2)
                  searchResult.push({ _uuid: item._uuid });
              }
            }
          }
          if (searchResult !== null)
            await iterateFunction(array, searchResult);
        }
      };
      let output = {};
  ...
  // src/classes/UserInterfaces/SSEditor/index.jsx
  var React2 = __toESM(require_react());
  var SSUserInterface = React2.createContext();
  var SSEditor = class {
    ...
    async load(action = {}) {
      ...
      for (let array in dependencies) {
        ...
        for (let item of dependencies[array]) {
          ...
          if (array === "group_uuid") {
            this.state[array].push(await this.assembly.getState(type, {
              _uuid: this.uuid,
      ...
      for (var i = 0; i < orderOfArrays.length; i++) {
        ...
        for (let index = 0; index < this.state[array].length; index++) {
          ...
          if (array.split("_")[0] === "link" || array.split("_")[0] === "property")
            arrayOutput.push(/* @__PURE__ */ React2.createElement("br", {
              key: type + "_" + identityString + "_br"
            }));
          const Item = All_exports[convertCamelCaseToSS(type)];
          arrayOutput.push(/* @__PURE__ */ React2.createElement(Item, {
            key: type + "_" + identityString + "_item",
            identityString,
            selectedObject: this.selected.selected,
            templateThis,
            assembly: this.assembly
          }));
          if ((array === "group_uuid" || array === "object_uuid" || array === "group_parent") && index + 1 < this.state[array].length)
            arrayOutput.push(", ");
      ...
      return /* @__PURE__ */ React2.createElement("div", null, /* @__PURE__ */ React2.createElement(SSUserInterface.Provider, {
        value: (action2) => this.listener.dispatch(action2)
      }, renderOutput), /* @__PURE__ */ React2.createElement("br", null), /* @__PURE__ */ React2.createElement("br", null), "Selected Element: [", /* @__PURE__ */ React2.createElement("span", null, window.selected.selectedString), "]", /* @__PURE__ */ React2.createElement("span", {
        className: "white",
        onClick: () => window.selected.add()
      }, "(+)"), /* @__PURE__ */ React2.createElement("span", {
        className: "white",
        onClick: () => window.selected.remove()
      }, "(-)"), /* @__PURE__ */ React2.createElement("br", null), "Insert an Item: ", /* @__PURE__ */ React2.createElement("span", {
        style: { verticalAlign: "top", display: "inline-block" }
      }, "#%%%%%%%%", /* @__PURE__ */ React2.createElement("span", {
        className: "white",
        onClick: () => window.selected.add("group_parent")
      }, "(+)"), ": #%%%%%%%%", /* @__PURE__ */ React2.createElement("span", {
        className: "white",
        onClick: () => window.selected.add("object_uuid")
      }, "(+)"), " this: #%%%%%%%%", /* @__PURE__ */ React2.createElement("span", {
        className: "white",
        onClick: () => window.selected.add("group_uuid")
      }, "(+)"), /* @__PURE__ */ React2.createElement("br", null), "#%%%%%%%%", /* @__PURE__ */ React2.createElement("span", {
        className: "white",
        onClick: () => window.selected.add("link_uuid")
      }, "(+)"), ": #%%%%%%%%", /* @__PURE__ */ React2.createElement("span", {
        className: "white",
        onClick: () => window.selected.add("link_start")
      }, "(+)"), " <-> #%%%%%%%%", /* @__PURE__ */ React2.createElement("span", {
        className: "white",
        onClick: () => window.selected.add("link_end")
      }, "(+)"), /* @__PURE__ */ React2.createElement("br", null), "#%%%%%%%%", /* @__PURE__ */ React2.createElement("span", {
        className: "white",
        onClick: () => window.selected.add("property_uuid")
      }, "(+)"), ": #%%%%%%%%", /* @__PURE__ */ React2.createElement("span", {
        className: "white",
        onClick: () => window.selected.add("property_parent")
  ...
  // src/classes/Elements/SSThis.jsx
  var SSThis = class extends SSElement {
    constructor(props) {
      super(props);
    ...
    render() {
      ...
      return /* @__PURE__ */ React3.createElement(SSUserInterface.Consumer, null, (dispatch) => {
        if (this.props.dispatch)
          dispatch = this.props.dispatch;
        return /* @__PURE__ */ React3.createElement("span", {
          id: this.props.id,
          onClick: this.onClick(this, dispatch),
          style
        }, "#this");
      });
    }
  ...
  // src/classes/Elements/SSSelector.jsx
  var React4 = __toESM(require_react());
  var SSSelector = class extends SSElement {
    constructor(props) {
      super(props);
      this.state = { "red": false };
    }
    ...
    render() {
      ...
      return /* @__PURE__ */ React4.createElement(SSUserInterface.Consumer, null, (dispatch) => {
        if (this.props.dispatch)
          dispatch = this.props.dispatch;
  ...
  // src/classes/Elements/SSAdd.jsx
  var React5 = __toESM(require_react());
  var SSAdd = class extends SSElement {
    constructor(props) {
      super(props);
      this.state = { "red": false };
    }
    ...
    render() {
      ...
      return /* @__PURE__ */ React5.createElement(SSUserInterface.Consumer, null, (dispatch) => {
        if (this.props.dispatch)
          dispatch = this.props.dispatch;
  ...
  // src/classes/Elements/SSRemove.jsx
  var React6 = __toESM(require_react());
  var SSRemove = class extends SSElement {
    constructor(props) {
      super(props);
      this.state = { "red": false };
    }
    ...
    render() {
      ...
      return /* @__PURE__ */ React6.createElement(SSUserInterface.Consumer, null, (dispatch) => {
        if (this.props.dispatch)
          dispatch = this.props.dispatch;
  ...
  // src/classes/Elements/SSButton.jsx
  var React7 = __toESM(require_react());
  var Button = class extends SSElement {
    constructor(props) {
      super(props);
      this.state = { "elementValue": convertHTMLToBoolean(this.props.elementValue) };
    }
    onClick(classInstance, dispatchFunction) {
      return function(event) {
        var newValue;
    ...
    render() {
      ...
      return /* @__PURE__ */ React7.createElement(SSUserInterface.Consumer, null, (dispatch) => {
        if (this.props.dispatch)
          dispatch = this.props.dispatch;
        return /* @__PURE__ */ React7.createElement("button", {
          ...
          onClick: this.onClick(this, dispatch),
          style
        }, convertBooleanToDirection(convertHTMLToBoolean(this.state.elementValue)));
      });
    }
  };

  // src/classes/Elements/SSKey.jsx
  var React8 = __toESM(require_react());
  var SSKey = class extends SSElement {
    constructor(props) {
      super(props);
    ...
    render() {
      ...
      return /* @__PURE__ */ React8.createElement(SSUserInterface.Consumer, null, (dispatch) => {
        if (this.props.dispatch)
          dispatch = this.props.dispatch;
        return /* @__PURE__ */ React8.createElement("input", {
          ...
          maxLength: "8",
          onInput: this.onInputOrChange(this, dispatch),
          onChange: this.onInputOrChange(this, dispatch),
          onClick: this.onClick(this, dispatch),
          style
        });
      });
  ...
  // src/classes/Elements/SSInput.jsx
  var React9 = __toESM(require_react());
  var SSInput = class extends SSElement {
    constructor(props) {
      super(props);
      this.state = { "elementValue": this.props.elementValue };
    }
    ...
    render() {
      ...
      return /* @__PURE__ */ React9.createElement(SSUserInterface.Consumer, null, (dispatch) => {
        if (this.props.dispatch)
          dispatch = this.props.dispatch;
  ...
  // src/classes/Elements/SSTextarea.jsx
  var React10 = __toESM(require_react());
  var SSTextarea = class extends SSElement {
    constructor(props) {
      super(props);
      this.state = { "elementValue": this.props.elementValue };
    }
    ...
    render() {
      ...
      style.width = dimensions.width;
      style.height = dimensions.height;
      return /* @__PURE__ */ React10.createElement(SSUserInterface.Consumer, null, (dispatch) => {
        if (this.props.dispatch)
          dispatch = this.props.dispatch;
        return /* @__PURE__ */ React10.createElement("textarea", {
          id: this.props.id,
          type: "text",
          value: this.state.elementValue,
          onInput: this.onInputOrChange(this, dispatch),
  ...
  // src/classes/Items/SSItem.jsx
  var React11 = __toESM(require_react());
  var SSItem = class extends React11.Component {
    generateJSXFromTemplate(identityString, selectedObject, item, templateThis, templateArray) {
      var getRed = function(action = "_element") {
        if (selectedObject.array === null)
          return false;
        if (item._type !== selectedObject.array.split("_")[0])
          return false;
        if (identityString !== selectedObject.identityString)
          return false;
        if (action !== selectedObject.action)
          return false;
        return true;
      };
      var itemAddRemove = function(identityString2, item2) {
        var outputArray = [];
        if (item2._add === true) {
          const Add = SSAdd;
          outputArray = [...outputArray, " ", /* @__PURE__ */ React11.createElement(Add, {
            templateType: item2._type,
            templateThis,
            id: identityString2,
            red: getRed("_add")
          })];
        }
        if (item2._remove === true) {
          const Remove = SSRemove;
          outputArray = [...outputArray, " ", /* @__PURE__ */ React11.createElement(Remove, {
            templateType: item2._type,
            templateThis,
            id: identityString2,
            red: getRed("_remove")
      ...
      for (let j = 0; j < templateArray.length; j++) {
        if (Array.isArray(templateArray[j])) {
          const elementName = convertCamelCaseToSS(templateArray[j][1]);
          if (templateArray[j][0] === true) {
            const Element = All_exports2[elementName];
            processArray.push(/* @__PURE__ */ React11.createElement(Element, {
              key: identityString + "_" + j,
              templateType: item._type,
              templateThis,
              id: identityString,
              elementKey: "_" + templateArray[j][2],
              elementValue: item["_" + templateArray[j][2]],
              red: getRed()
            }));
          ...
          if (templateArray[j] === "\n") {
            processArray.push(/* @__PURE__ */ React11.createElement("br", {
              key: identityString + "_" + j
            }));
          } else {
            processArray.push(templateArray[j]);
  ...
  // src/classes/Items/SSObject.jsx
  var React12 = __toESM(require_react());
  var SSObject = class extends SSItem {
    constructor() {
      super();
    }
    render() {
    ...
    validate(validateTarget = null) {
      ...
      if (validateTarget._type !== "object")
        return false;
      if (!isValidKey(validateTarget._uuid))
        return false;
      return true;
    }
  };

  // src/classes/Items/SSGroup.jsx
  var React13 = __toESM(require_react());
  var SSGroup = class extends SSItem {
    constructor() {
      super();
    }
    render() {
    ...
    validate(validateTarget = null) {
      ...
      if (validateTarget._type !== "group")
        return false;
      if (!isValidKey(validateTarget._uuid))
        return false;
      if (!isValidKey(validateTarget._parent))
        return false;
      return true;
    }
  };

  // src/classes/Items/SSLink.jsx
  var React14 = __toESM(require_react());
  var SSLink = class extends SSItem {
    constructor() {
      super();
    }
    render() {
    ...
    validate(validateTarget = null) {
      ...
      if (validateTarget._type !== "link")
        return false;
      if (!isValidKey(validateTarget._uuid))
        return false;
      if (!isValidKey(validateTarget._start))
        return false;
      if (!isValidKey(validateTarget._end))
        return false;
      if (!isValidDirection(validateTarget._direction))
        return false;
      return true;
    }
  };

  // src/classes/Items/SSProperty.jsx
  var React15 = __toESM(require_react());
  var SSProperty = class extends SSItem {
    constructor() {
      super();
    }
    render() {
    ...
    validate(validateTarget = null) {
      ...
      if (validateTarget._type !== "property")
        return false;
      if (!isValidKey(validateTarget._uuid))
        return false;
      if (!isValidKey(validateTarget._parent))
        return false;
      if (!isValidSingleLineString(validateTarget._name))
        return false;
      if (!isValidMultiLineString(validateTarget._content))
        return false;
      return true;
    }
  };
  ...
  // src/classes/SSAssembly.js
  var SSAssembly = class {
    constructor() {
    ...
    async get(type, details) {
      ...
      return this.state[type][identityToString(type, details)];
    }
    async set(type, details) {
      details = await this.generateKeys(details);
      var identity = JSON.parse(JSON.stringify(details));
      for (let property in identity) {
        if (!(property === "_uuid" || property === "_parent" && type === "group"))
    ...
    async getState(type, identity) {
      var identityString = identityToString(type, identity);
      if (typeof this.state[type][identityString] === "undefined") {
        ...
        if (item._success === true) {
          let validatorClass = new All_exports[convertCamelCaseToSS(type)]();
    ...
    async setState(type, identity, content) {
      ...
      if (typeof this.state[type][identityString] === "undefined") {
        if (content._remove === true)
          throw "Unable to remove item that does not exist";
        var loadCommand = this.identityToLoadCommand(type, identity);
        var item = await this.sender.send(loadCommand[0], loadCommand[1]);
        ...
        if (content._add === true)
          throw "Unable to add item that already exists";
      ...
      let itemInstance = new All_exports[convertCamelCaseToSS(type)]();
        ...
        for (let identityString in this.state[type]) {
          ...
          if (item._add === true || item._remove === true) {
            if (item._add === true) {
              ...
              this.sender.pushCallback(function() {
                delete item._add;
              }.bind(this));
            }
            if (item._remove === true) {
              ...
              this.sender.pushCallback(function() {
                delete this.state[type][identityToString(type, item)];
              }.bind(this));
            }
          } else if (item._save === true) {
            const identity = identityFromString(type, identityString);
            if (item._type === "object") {
            ...
            this.sender.pushCallback(function() {
              var identityStringToDelete = identityToString(type, identity);
              var identityStringToAdd = identityToString(type, item);
              if (item._save)
                delete item._save;
  ...
  // src/classes/SSSelected.js
  var SSSelected = class {
    constructor() {
    ...
    async removeAddAction() {
      ...
      var details = identityFromString(type, this.selected.identityString);
  ...
  // src/classes/SSListener.js
  var SSListener = class {
    ...
    async dispatch(action = {}) {
      if (action.type === "SELECT") {
        ...
        const identity = identityFromString(action.targetType, action.targetId);
  ...
  // src/classes/UserInterfaces/All.js
  var All_exports3 = {};
  __export(All_exports3, {
    SSAliase: () => SSAliase,
    SSEditor: () => SSEditor
  });

  // src/classes/UserInterfaces/SSAliase/Aliase.jsx
  var React16 = __toESM(require_react());
  var Aliase = class extends React16.Component {
    constructor(props) {
      super(props);
      this.state = {
        edit: 0,
    ...
    render() {
      if (this.state.edit === 0) {
        return /* @__PURE__ */ React16.createElement("span", null, /* @__PURE__ */ React16.createElement("span", {
          onClick: () => {
            this.setState({
              edit: 1
            });
        ...
        }, "E"), ": ", /* @__PURE__ */ React16.createElement(SSKey, {
          id: this.props.source,
          elementValue: this.state.target,
          dispatch: (action) => {
            if (action.type === "SAVE")
              this.onInputOrChange(this, this.props.save)(action);
            return true;
          }
        }));
      }
  ...
  // src/classes/UserInterfaces/SSAliase/index.jsx
  var React17 = __toESM(require_react());
  var SSUserInterface2 = React17.createContext();
  var SSAliase = class {
    constructor(uuid, assembly, selected, listener) {
      this.uuid = uuid;
      this.assembly = assembly;
    ...
    async load(action = {}) {
      ...
      if (await async function() {
        ...
        if (dependencies["property_parent"]) {
          for (let identity of dependencies["property_parent"]) {
            ...
            if (item._success === true && item._name === "Target") {
              if (isValidKey(item._content) === true) {
        ...
        return /* @__PURE__ */ React17.createElement(SSUserInterface2.Provider, {
          value: (action2) => this.listener.dispatch(action2)
        }, /* @__PURE__ */ React17.createElement(Aliase, {
    ...
    async save(action = {}) {
      ...
      if (dependencies["property_parent"]) {
        for (let identity of dependencies["property_parent"]) {
          ...
          if (item._success === true && item._name === "Target") {
            if (isValidKey(action.target) === true) {
  ...
  var SSOpener = class {
    ...
    async openUuid(uuid) {
      for (const userInterface in All_exports3) {
        const loadedClass = All_exports3[userInterface];
    ...
    async getClass(name) {
      for (const userInterface in All_exports3) {
        ...
        if (userInterface === name) {
          const loadedClass2 = All_exports3[userInterface];
          return loadedClass2;
        }
      }
  ...
  // src/index.jsx
  ReactDOM.render(/* @__PURE__ */ React18.createElement("div", null, /* @__PURE__ */ React18.createElement("div", {
    id: "renderZone"
  }, "Content will be rendered here", /* @__PURE__ */ React18.createElement("br", null)), /* @__PURE__ */ React18.createElement("br", null), "Documentations: ", /* @__PURE__ */ React18.createElement("span", {
    className: "white",
    onClick: () => window.open("/resources/documentations.html", "_blank")
  }, "(View)"), /* @__PURE__ */ React18.createElement("br", null), "Editor Actions: ", /* @__PURE__ */ React18.createElement("span", {
    className: "white",
    onClick: () => window.assembly.syncWithServer().then(() => window.renderFunction())
  }, "(Save)"), /* @__PURE__ */ React18.createElement("br", null)), document.body);
  ...
  window.renderFunction = async function() {
    ...
    ReactDOM.render(/* @__PURE__ */ React18.createElement("div", null, content), document.getElementById("renderZone"));
  };
